...
<style>
   ...
   <br><br>
    <div class="container text-center">
            <h1>
                <i class="fas fa-edit me-2"></i>Modifier une Direction
            </h1>
            <p class="lead mb-0">Mise à jour des informations de la direction</p>
        </div>
        <br><br>
    ...
    <!-- Formulaire de Modification -->
        ...
        <div class="edit-form-container">
            <form action="validermodifedepart.php" method="post">
                <div class="mb-4">
                    <label for="department_name" class="form-label">Nom de la direction</label>
                    <input type="text" class="form-control" id="department_name" 
                           name="s_department_name" value="<?= htmlspecialchars($departments['department_name']) ?>" required>
                </div>
                
                <input type="hidden" name="department_id" value="<?= htmlspecialchars($department_id) ?>">
                
                <div class="action-buttons">
                    <a href="listdepart.php" class="btn-cancel">
